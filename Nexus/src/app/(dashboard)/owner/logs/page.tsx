    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-bold text-white tracking-tight">Unit Audit Logs</h1>
                    <p className="text-slate-400 mt-1">Review access events for your specific unit.</p>
                </div>
                ...
                <div className="border-b border-slate-700/50 p-4 flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div className="flex bg-slate-900/50 p-1 rounded-xl border border-slate-700/50 w-full md:w-auto">
                        {['all', 'access'].map((f) => (
                            ...
                            >
                                {f === 'all' ? 'All Events' : 'Access Grants'}
                            </button>
                        ))}
                    </div>
